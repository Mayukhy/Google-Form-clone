...
<img className=' object-cover w-full md:h-[200px] lg:h-[300px] h-[150px]' src={banner} alt="" />
    ...
    <Card className='border-t-[11px] border-t-[#8f38ba] transition-all duration-200 hover:scale-105 cursor-pointer' sx={{width:{lg:'700px',md:'600px',sm:'500px',xs:'100%'},py:2,transition:'all 0.3s',borderRadius:'10px'}}>
        <CardContent>
