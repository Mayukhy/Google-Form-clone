...
export default function Form({ formdata, setFormdata, currentId, setCurrentId, userinfo }) {
  ...
  return (
    <div onClick={()=>setMobilemenu(false)} className=' flex flex-col bg-violet-100 w-[100%] min-h-screen'>
      ...
      {isFilled && <Alert className=' mx-auto flex justify-center items-center' sx={{ background: '#ffc9b3', width: { lg: '700px', md: '600px', sm: '500px', xs: '100%' } }} severity="error">Please Fill the Tile & atleast one field</Alert>}
...
<br />
    ...
    />
        ...
        <Button sx={{ width: { lg: '700px', md: '600px', sm: '500px', xs: '100%' } }} onClick={handelsubmit} variant="contained" color='secondary' endIcon={<SendIcon />}>
